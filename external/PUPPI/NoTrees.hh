...
// fastjet::Selector SelectorEventTrimmer(double Rjet, double ptcut, double Rsub, double fcut);
...
public:
   ...
   virtual TOut result(const std::vector<fastjet::PseudoJet> &pjs) const = 0;

   TOut operator()(const std::vector<fastjet::PseudoJet> &pjs) const { return result(pjs);}
};
...
public:
   ...
   double result(const std::vector<fastjet::PseudoJet> & particles) const;
...
double var_within_R(int iId, const vector<fastjet::PseudoJet> & particles, const fastjet::PseudoJet& centre, double R);
double pt_within_R(const std::vector<fastjet::PseudoJet> & particles, const fastjet::PseudoJet& centre, double R);
fastjet::PseudoJet flow_within_R(const vector<fastjet::PseudoJet> & particles, const fastjet::PseudoJet& centre, double R);
double puppi_within_R(const vector<fastjet::PseudoJet> & particles, const fastjet::PseudoJet& centre, double R,bool iMass);
